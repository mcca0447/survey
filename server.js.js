...
app.get('/stats', async (req, res) =>{
  try {
    ...
    const topThreeIngr = await client.query('SELECT avoiding COUNT(*) AS avoiding_occurrence FROM  response_table GROUP BY avoiding ORDER BY avoiding_occurrence DESC LIMIT 3;');
